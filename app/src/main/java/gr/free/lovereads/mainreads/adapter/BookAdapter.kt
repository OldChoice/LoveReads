...
import gr.free.lovereads.mainreads.booktool.loadImage
import kotlinx.android.synthetic.main.listitme_booklist.view.*
import java.util.*
import kotlin.collections.ArrayList

/**
 * Create by guorui on 2019/12/5
...
class BookAdapter(private val bookSelectListener: BookSelectListener) :
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        val view = LayoutInflater.from(p0.context).inflate(R.layout.listitme_booklist, p0, false)
